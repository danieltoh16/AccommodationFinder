        ...
        <div class="col-lg-8 align-self-baseline">
          <div class="form-group has-danger">
              ...
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><font color="white" size="+2.5"><i class="fa fa-at"></font></i></div>
          ...
          <div class="form-group">
              ...
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><font color="white" size="+2.5"><i class="fa fa-key"></i></font></div>
                  <input type="password" name="password" class="form-control" id="password" placeholder="Password" required>
              </div>
          </div>
          <div class="form-group">
            <input type="checkbox" onclick="showPassFunction()"><font color="white">Show Password
            <script>
